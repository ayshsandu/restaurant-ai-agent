...
const ChatButton: React.FC<ChatButtonProps> = memo(({ onClick, hasNewMessage = false, isChatOpen = false }) => {
    const buttonClasses = isChatOpen 
        ? "fixed bottom-6 right-6 bg-green-800 hover:bg-green-900 text-white p-5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-green-800/50 z-40 group"
        : "fixed bottom-6 right-6 bg-green-800 hover:bg-green-900 text-white p-5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-green-800/50 z-40 group animate-bounce";
